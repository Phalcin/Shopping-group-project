      ...
      <Slider {...settings}>
        <div className="w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative">
          ...
          <div className="lg:absolute lg:top-1/2 lg:left-2/3 transform lg:-translate-x-1/2 lg:-translate-y-1/2 flex flex-col items-center gap-5">
            ...
            <Link href="/watches" legacyBehavior>
              <a className="text-base font-medium text-white bg-designColor rounded-md px-4 py-2">
                Select a product
              </a>
            </Link>
          </div>
        ...
        <div className="w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative">
          ...
          <div className="lg:absolute lg:top-1/2 lg:left-2/3 transform lg:-translate-x-1/2 lg:-translate-y-1/2 flex flex-col items-center gap-5">
            ...
            <p className="text-2xl font-semibold">Phone Cases in Demand</p>
            <Link href="/phonecases" legacyBehavior>
              <a className="text-base font-medium text-white bg-designColor rounded-md px-4 py-2">
                Select a product
              </a>
            </Link>
        ...
        <div className="w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative">
          ...
          <div className="lg:absolute lg:top-1/2 lg:left-2/3 transform lg:-translate-x-1/2 lg:-translate-y-1/2 flex flex-col items-center gap-5">
            ...
            <Link href="/phones" legacyBehavior>
              <a className="text-base font-medium text-white bg-designColor rounded-md px-4 py-2">
                Select a product
              </a>
            </Link>
